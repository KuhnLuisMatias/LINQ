...
{
    [UltimoAtributoModificado("19 Jul 2017", "updated for C# 7 and .NET Core 2")]
    [UltimoAtributoModificado("6 Jun 2015", "updated for C# 6 and .NET Core")]
    [UltimoAtributoModificado("14 Dec 2010", "IEnumerable interface implemented: Vector can be treated as a collection")]
    [UltimoAtributoModificado("10 Feb 2010", "IFormattable interface implemented Vector accepts N and VE format specifiers")]
    ...
    public class Vector : IFormattable, IEnumerable<double>
    {
        ...
        [UltimoAtributoModificado("19 Jul 2017", "Reduced the number of code lines")]
        ...
        [UltimoAtributoModificado("19 Jul 2017","changed ijk format from StringBuilder to format string")]
        ...
        [UltimoAtributoModificado("6 Jun 2015", "added to implement IEnumerable<T>")]
        ...
        [UltimoAtributoModificado("6 Jun 2015", "Change to implement the generic version IEnumerator<T>")]
        [UltimoAtributoModificado("14 Feb 2010", "Class created as part of collection support for Vector")]
